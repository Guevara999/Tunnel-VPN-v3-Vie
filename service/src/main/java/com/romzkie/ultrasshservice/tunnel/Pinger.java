...
public class Pinger extends Thread {
    ...
    public void run() {
		SkStatus.logInfo("Máy Chủ Pinger: " + this.b);
        try {
			SkStatus.logInfo("Đã Bắt Đầu Pinger");
            ...
            while (this.d) {
                try {
                    ...
                    if (readLine != null) {
						SkStatus.logInfo("Mã Phản Hồi: " + readLine);
                    } else {
						SkStatus.logInfo("Pinger: Không Có Dữ Liệu");
                    }
                ...
                try {
					...
					SkStatus.logInfo("Đã Dừng Pinger");
