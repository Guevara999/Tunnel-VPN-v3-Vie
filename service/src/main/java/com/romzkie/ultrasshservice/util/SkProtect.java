...
public class SkProtect {
    ...
    private static final String APP_BASE = new String(new byte[]{99,111,109,46,116,117,110,110,101,108,118,112,110,46,102,114,101,101});
	
    private static final String APP_NAME = new String(new byte[]{116,117,110,110,101,108,32,118,112,110});
